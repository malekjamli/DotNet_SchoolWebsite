...
namespace EnisFinal.Controllers
{
    public class GroupesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClassNumber")] Groupe groupe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClassNumber")] Groupe groupe)
        {
            if (id != groupe.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Groupe'  is null.");
            }
            var groupe = await _context.Groupe.FindAsync(id);
            if (groupe != null)
            {
